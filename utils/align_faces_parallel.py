...
SHAPE_PREDICTOR = dlib.shape_predictor(model_paths["shape_predictor"])
...
def align_face(image, output_size=256, transform_size=256):
    """
	:param image: PIL.Image or np.array
	:return: PIL Image
	"""
